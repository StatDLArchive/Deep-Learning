...
| :---: | :--- | :--- | :---: |
| <img src="https://m.media-amazon.com/images/I/61qBJmjJcCL._SL1360_.jpg" width="120"> | **Deep Learning** | Ian Goodfellow, Yoshua Bengio, Aaron Courville | [📖 Website](https://www.deeplearningbook.org/) |

---

## 🎯 Study Philosophy

우리는 Input과 Output을 명확히 구분하여 깊이 있는 학습을 지향.
할때 제대로 하기.
...
| :---: | :--- | :--- | :---: |
| **1** | 01.12 ~ 01.18 | Foundations of Deep Learning & Neuron Modeling | 1, 2 |
| **2** | 01.19 ~ 01.25 | Deep Feedforward Networks | 3 |
...
| **Member2** | Presenter | [@정민교](https://github.com/DEVJmK) |
...
- **코드는 재현 가능**하게 (seed / requirements / data note)
